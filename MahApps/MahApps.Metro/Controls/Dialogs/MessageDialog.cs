...
namespace MahApps.Metro.Controls.Dialogs
{
    ...
    public partial class MessageDialog : BaseMetroDialog
    {
        ...
        internal Task<MessageDialogResult> WaitForButtonPressAsync()
        {
            ...
            RoutedEventHandler dritteAuxHandler = null;
            KeyEventHandler dritteAuxKeyHandler = null;
            ...
            cleanUpHandlers = () => {
                ...
                //PART_DritteButton.Click -= dritteAuxHandler;
                ...
                //PART_DritteButton.KeyDown -= dritteAuxKeyHandler;
            ...
            dritteAuxKeyHandler = (sender, e) =>
            {
                if (e.Key == Key.Enter)
                {
                    cleanUpHandlers();
                    tcs.TrySetResult(MessageDialogResult.DritteButton);
                }
            };
        ...
        public static readonly DependencyProperty DritteButtonTextProperty = DependencyProperty.Register("DritteButtonTextProperty", typeof(string), typeof(MessageDialog), new PropertyMetadata("Cancel"));
        ...
        public string DritteButtonText
        {
            get { return (string)GetValue(DritteButtonTextProperty); }
            set { SetValue(DritteButtonTextProperty, value); }
        }
